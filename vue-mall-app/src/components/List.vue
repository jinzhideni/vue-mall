<template>
  <div class="list-wrapper" @touchstart="disB = 0" @touchmove="up" @touchend="end" ref="wrapper">
    ...
    <div
      class="list-content"
      v-if="!showLoading"
      :style="{ transform: `translateY(-${this.disB}px)` }"
      ref="list"
    >
      <van-pull-refresh v-model="isLoad" @refresh="onRefresh" head-height="80">
        <van-list v-model="loading" :finished="finished" @load="onLoad" :finished-text="msg">
          <Card
